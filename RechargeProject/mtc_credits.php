...
<div class="mt-5 text-center">
        ...
        <img class="rounded-4 shadow  " src="img/touch/touchc.png" style="height:150px; width:250px">
 ...
 <div class="container ">
     ...
     <form method="POST" class="ms-5 mt-4">
                ...
                <!-- Credits Input -->
                    ...
                    <div class="input-group mt-2  shadow-sm" style="width:130px;">
                        <div class="input-group-prepend">
                            <span style="background-color:#6ec2d6; color:white ;" class="input-group-text rounded-0 rounded-start" id="credits-addon">Credits</span>
                        </div>
                        <input type="number" name="credits" class="form-control" id="credits" oninput="updatePrice()" placeholder="" aria-label="" aria-describedby="credits-addon">
                    </div>
...
<div class="d-grid gap-2 col-6 mx-auto mt-5   shadow-sm" >
        <button type="submit" name="credit_confirm" class="btn"  style="background-color:#009FB4;color:white">Confirm</button>
      </div>
